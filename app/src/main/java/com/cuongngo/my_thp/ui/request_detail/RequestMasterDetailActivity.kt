...
import com.cuongngo.my_thp.base.dialog_fragment.ConfirmAddRequestDialog
...
import com.cuongngo.my_thp.data.database.roomdb.entity.ProcessStep
...
import com.cuongngo.my_thp.data.database.roomdb.entity.convertRequestEntityToString
import com.cuongngo.my_thp.data.database.roomdb.entity.randomBoolean
import com.cuongngo.my_thp.data.database.roomdb.entity.randomDate
import com.cuongngo.my_thp.data.database.roomdb.entity.toDataClass
import com.cuongngo.my_thp.data.local.AppPreferences
import com.cuongngo.my_thp.databinding.ActivityRequestMasterBinding
...
import com.cuongngo.my_thp.ui.bottom_sheet.SearchUserBottomSheet
...
import com.cuongngo.my_thp.ui.request_detail.SheetDetailActivity.Companion.RESULT_BODY_DATA
import com.cuongngo.my_thp.ui.request_detail.adapter.FormHeaderAdapter
import com.cuongngo.my_thp.ui.request_detail.adapter.RequestProcessStepAdapter
import com.cuongngo.my_thp.ui.request_detail.adapter.SheetAdapter
import com.cuongngo.my_thp.ui.user_thp.adapter.UserAddedAdapter
import com.cuongngo.my_thp.utils.Constants.CategoryRequestDetail.Companion.ADD
import com.cuongngo.my_thp.utils.date.getCurrentDateTime
...
import com.cuongngo.my_thp.utils.toast.showMessageSaveData
