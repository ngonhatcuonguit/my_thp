...
import com.cuongngo.core_project.common.enum.FontType

class EditTextEx: androidx.appcompat.widget.AppCompatEditText {
    ...
    private fun init(context: Context, attrs: AttributeSet?) {
        val typedArray: TypedArray = context.obtainStyledAttributes(attrs, R.styleable.EditTextEx)
        val textStyle = typedArray.getInt(R.styleable.EditTextEx_fontType, FontType.NORMAL.typeValue)
